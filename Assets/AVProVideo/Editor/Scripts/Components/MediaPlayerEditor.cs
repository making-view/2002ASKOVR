...
namespace RenderHeads.Media.AVProVideo.Editor
{
	...
	public partial class MediaPlayerEditor : UnityEditor.Editor
	{
		...
		[MenuItem("GameObject/Video/AVPro Video - Media Player", false, 10)]
		...
		[MenuItem("GameObject/Video/AVPro Video - Media Player with Unity Audio", false, 0)]
		...
		private void FixRogueEditorBug()
		{
			...
			// It causes a problem (at leave in Unity 2020.1.11) where the System.Action invocations (usd by AnimCollapseSection)
		...
		private void OnInspectorGUI_Visual()
		{
			...
			EditorGUILayout.Toggle("Pre-resolve", true);
			EditorGUILayout.Toggle("Generate Mipmaps", true);
			GUILayout.BeginHorizontal();
			EditorGUILayout.PrefixLabel("Tint");
			EditorGUILayout.ColorField(Color.red);
			GUILayout.EndHorizontal();

			EditorGUILayout.Toggle("HSBC", true);
			EditorGUI.indentLevel++;
			GUILayout.BeginHorizontal();
			EditorGUILayout.PrefixLabel("Hue");
