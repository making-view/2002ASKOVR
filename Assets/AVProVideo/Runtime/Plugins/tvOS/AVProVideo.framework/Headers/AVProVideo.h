...
//! Project version number for AVProVideo.
FOUNDATION_EXPORT double AVProVideoVersionNumber;

//! Project version string for AVProVideo.
...
void         AVPPluginSetLogFunction(AVPLogCallback callback, int encoding);
void         AVPPluginSetLogLevel(AVPLogLevel level);
