...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class PlaylistMediaPlayer : MediaPlayer, ITextureProducer
	{
		...
		[SerializeField] Transition _nextTransition = Transition.None;
		[SerializeField] float _transitionDuration = 1f;
		[SerializeField] Easing _transitionEasing = null;
		...
		public void OpenVideoFile(MediaPlaylist.MediaItem mediaItem)
 		{
			...
			this.MediaPath = NextPlayer.MediaPath = mediaItem.mediaPath;
